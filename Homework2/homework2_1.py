...
svm_positive = svm.SVC(kernel='poly', probability=True)
svm_indifference = svm.SVC(kernel='poly', probability=True)
svm_negative = svm.SVC(kernel='poly', probability=True)
